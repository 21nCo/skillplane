...
function inspectBundle(path, content) {
  ...
  if (
    ...
    /AUTHFN_SECRET|OAUTH_TOKEN_PEPPER|POSTHOG_PROJECT_TOKEN|SKILLPLANE_PRODUCTION_DATABASE_URL|SKILLPLANE_PRODUCTION_MIGRATION_SOURCE_DATABASE_URL|RAILWAY_DATABASE_URL|TURNSTILE_SECRET_KEY/gu.test(
      content,
    )
  ) {
